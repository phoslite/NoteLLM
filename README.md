...
| 文档 | 版本 | 内容 |
| --- | --- | --- |
| [需求文档.md](需求文档.md) | v1.42 | 需求边界、开放项与验收标准 |
| [技术栈规范.md](技术栈规范.md) | v1.52 | 技术选型、工程规范、解耦/重构规则 |
| [重构规范.md](重构规范.md) | v1.27 | 重构记录表与变更记录 |
| [docs/使用手册.md](docs/使用手册.md) | v1.78 | 已实现函数的使用与修改手册 |
