...
class ChatMessage(Base):
    ...
    ref_book_id: Mapped[int | None] = mapped_column(ForeignKey("books.id"), nullable=True)
    ref_chapter_id: Mapped[int | None] = mapped_column(ForeignKey("chapters.id"), nullable=True)
